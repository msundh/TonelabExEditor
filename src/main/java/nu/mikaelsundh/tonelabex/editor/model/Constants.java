...
//    public static final String[] ampModelNormal = {"CLEAN ","CALI CLEAN ","US BLUES ","US 2x12","VOX AC15","VOX AC30","UK ROCK","UK METAL","US HIGAIN","US METAL ","BTQ METAL"};
    public static final String[] ampModelSpecial = {"Roland JC120","Fender 57 Tweed Twin","Bruno Cowtipper","Valvetech Hayseed","1950's AC15","VOX AC30HH","UMarshall JCM800","Marshall JVM410","Soldano Slo","VHT Pittbull","Diezel VH4"};
